...
const Speakers = () => {
    ...
    return (
        <div className="flex flex-col">
            <Navbar />
            <Banner bg_image={bannerImage} cover_image={coverImage} text={<span className="font-bold font-Medium-500">SPEAKERS</span>} />
            <div className="w-full m-auto max-w-[1200px] px-10">
                <div className=" text-[46px] font-bold font-Medium-500 my-[100px] text-[#141d50]">
                    PREVIOUS SPEAKERS
                </div>
